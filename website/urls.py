...
urlpatterns = [
    ...
    path("dashboard/prep-by-topics/", views.student_objectives_topics, name="student_objectives_topics"),
    path("dashboard/prep-by-topics/submit/", views.student_objectives_submit_result, name="student_objectives_submit_result"),
    path("dashboard/prep-by-topics/<uuid:topic_id>/", views.student_objectives_practice, name="student_objectives_practice"),
    path("dashboard/mnemonics-guide/", views.student_mnemonics_guide, name="student_mnemonics_guide"),
    path("dashboard/mnemonics-guide/<slug:section_slug>/", views.student_mnemonics_section, name="student_mnemonics_section"),
    ...
    path("dashboard/free-test/", views.student_free_test, name="student_free_test"),
    path("dashboard/free-test/start/", views.student_free_test_start, name="student_free_test_start"),
    path("dashboard/free-test/attempt/<uuid:attempt_id>/", views.student_free_test_attempt, name="student_free_test_attempt"),
    path("dashboard/free-test/attempt/<uuid:attempt_id>/result/", views.student_free_test_result, name="student_free_test_result"),
    ...
    path("admin-panel/objectives/", views.admin_objectives, name="admin_objectives"),
